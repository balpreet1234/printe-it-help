...
<section class="py-5 bg-light">
    ...
    <div class="container bg-white py-md-5 py-4 px-md-5 px-4 position-relative z-1 box_shadow border_radius_6 my-xl-5">
